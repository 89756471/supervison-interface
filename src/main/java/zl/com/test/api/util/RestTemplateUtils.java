...
public class RestTemplateUtils {
    ...
    @SuppressWarnings("unchecked")
    public static Map<String, Object> PostJson(String url, Map<String, Object> var) {
        RestTemplate restTemplate = new RestTemplate();
        HttpHeaders headers = new HttpHeaders();
    ...
    @SuppressWarnings("unchecked")
    public static Map<String, Object> PostJson1(String url, JSONObject var) throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        HttpHeaders headers = new HttpHeaders();
        MediaType type = MediaType.parseMediaType("application/json; charset=UTF-8");
        headers.setContentType(type);
        headers.add("Accept", MediaType.APPLICATION_JSON.toString());
        HttpEntity<String> formEntity = new HttpEntity<String>(var.toString(), headers);
        Map<String, Object> result = restTemplate.postForObject(url, formEntity, Map.class);
        return result;
    }
